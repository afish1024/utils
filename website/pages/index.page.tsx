            ...
            <Fragment key={item.id}>
              ...
              <p className="text-gray-300">
                ...
                <a
                  ...
                  href={`./coverage/${item.slug}.ts.html`}
                >
                  {item.slug}.ts
                </a>
              </p>
  ...
  return (
    <>
      ...
      <div className="container" id="top">
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <h1 className="bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-3xl font-bold leading-snug text-transparent">
                {siteMetaData.title} <span className="text-xs">{packageJson.version}</span>
              </h1>
            </a>
        ...
        <aside className="fixed bottom-5 top-20 hidden overflow-y-auto overflow-x-hidden pt-16 scrollbar-track-gray-900 scrollbar-thumb-gray-500 md:block md:w-40 lg:w-60">
